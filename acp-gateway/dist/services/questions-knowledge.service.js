...
exports.questionsKnowledge = exports.QuestionsKnowledgeService = void 0;
...
function canUseReverseContainment(term, keyword) {
...
class QuestionsKnowledgeService {
    constructor() {
        this.entries = [];
        this.loaded = false;
...
exports.QuestionsKnowledgeService = QuestionsKnowledgeService;
exports.questionsKnowledge = new QuestionsKnowledgeService();
//# sourceMappingURL=questions-knowledge.service.js.map