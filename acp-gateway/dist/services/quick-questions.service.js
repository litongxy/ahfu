...
exports.quickQuestionsService = exports.QuickQuestionsService = void 0;
...
class QuickQuestionsService {
    ...
    getQuestions(limit = MAX_QUESTION_COUNT) {
    ...
    buildQuestions() {
        ...
        const seen = new Set();
        let nextId = 1;
        const pushQuestion = (question, scene) => {
...
exports.QuickQuestionsService = QuickQuestionsService;
exports.quickQuestionsService = new QuickQuestionsService();
//# sourceMappingURL=quick-questions.service.js.map