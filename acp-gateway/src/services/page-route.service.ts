...
export class PageRouteService {
  private routes: Map<string, PageRoute> = new Map();
  ...
  getRecommendedRoutes(message: string, limit: number = 3): PageRoute[] {
...
export const pageRouteService = new PageRouteService();